...
union{
    ...
    #local B=text { ttf Font "Big" 1, 0 scale sFont*2 rotate -90*z }
    #local P=text { ttf Font "Picture" 1, 0 scale sFont}
    union{
        object{T centertext(T) translate -0.5*z txtBox(COL)}
        object{B centertext(B) translate -0.5*z rotate 90*y txtBox(COL)}                        
